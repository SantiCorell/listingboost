...
export const metadata: Metadata = {
  ...
  title: {
    default: `${APP_NAME} — SEO operativo, auditoría web y listing intelligence`,
    template: `%s · ${APP_NAME}`,
  },
  description: `${APP_NAME}: herramienta SEO para ecommerce y catálogo con ${ENGINE_NAME}. Palabras clave y brechas en Google, auditoría on-page de URLs, seguimiento SERP y fichas multicanal listas para publicar.`,
  ...
  openGraph: {
    ...
    url: siteUrl,
    siteName: APP_NAME,
    title: `${APP_NAME} — SEO operativo, auditoría y catálogo con IA`,
    description:
      "Keywords y brechas en la SERP, auditoría de páginas, rankings y fichas multicanal. Para equipos que publican mucho y necesitan datos accionables.",
  },
  twitter: {
    card: "summary_large_image",
    title: `${APP_NAME} | SEO, SERP y listings en un flujo`,
    description:
      "Investigación en Google, auditoría on-page, seguimiento de posiciones y copy multicanal con IA.",
  },
  icons: {
